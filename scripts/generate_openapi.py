...
EXTRA_INFO = {
    ...
    "tags": [
        {"name": "Memories", "description": "Ingest and retrieve memories"},
        {"name": "Search", "description": "Hybrid search across memory and RAG"},
        {"name": "Profiles", "description": "Entity profiles and context"},
        {"name": "Upload", "description": "File upload and pipeline tracking"},
        {"name": "Connectors", "description": "External data source integrations"},
